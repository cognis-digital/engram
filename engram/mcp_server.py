"""A minimal Model Context Protocol (MCP) server exposing engram memory over stdio.
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(
        prog="engram-mcp",
        description="MCP stdio server exposing engram remember/recall.",
    )
    parser.add_argument(
        "--db",
        default=os.environ.get("ENGRAM_DB", "engram_memory.sqlite"),
